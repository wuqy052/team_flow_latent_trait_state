...
plt.rcParams.update({'font.family':'avenir'})
plt.rcParams["figure.figsize"] = (6,5)
plt.scatter(rsa_corr_trial['edist'].loc[rsa_corr_trial['repeated']==0],rsa_corr_trial['beh'].loc[rsa_corr_trial['repeated']==0],s=10,alpha=0.1,c='#41b6c4')
plt.scatter(rsa_corr_trial['edist'].loc[rsa_corr_trial['repeated']==1],rsa_corr_trial['beh'].loc[rsa_corr_trial['repeated']==1],s=10,alpha=0.3,c='#aed9bb')
