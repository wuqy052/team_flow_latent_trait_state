...
**Now in press at Scientific Report**
<img src="cover.jpeg" alt="3-dimensional latent neural trait-state space" width="800"/>
## Abstract
...
analysis: main analysis scripts for the paper.

data: input data for all the analyses.

figures: organized datafile to create figures, and scripts to reproduce the figures.

results: output results from the analysis scripts.
